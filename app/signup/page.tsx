      ...
      <Card className="w-full">
        ...
        <CardContent className="grid gap-4">
          ...
          <div className="grid gap-2">
            <Button variant="outline" onClick={signupGoogle} className="flex items-center gap-2">
            ...
            <Button variant="outline" onClick={signupLinkedIn} className="flex items-center gap-2">
